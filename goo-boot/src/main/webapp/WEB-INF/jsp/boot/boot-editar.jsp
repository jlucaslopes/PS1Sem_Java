	...
	<div class="container-boot ">
		<div class="cardboot" style="width: 23rem;">
			...
			<div class="card-body">
				...
				<p class="card-text cardtext-boot">Aqui você pode alterar todos
					os dados do seu bot, sem limites de modificação por bot.</p>
			</div>
		</div>
	</div>
				...
				<div class="col-lg-12">
					<div class="well mt-2">
						...
						<form:form modelAttribute="botModel"
							action="${contextPath}/boot/${botModel.id_bot}" method="put">
